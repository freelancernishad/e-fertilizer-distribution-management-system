						...
						<div class="col-lg-12">
							...
							<div class="login-form">
								<div class="text-center">
									<h1 class="h4 text-gray-900 mb-4 fromTitle">ইউজার অন্তর্ভূক্তি ফরম</h1>
								</div>
								<form @submit.prevent='updateCategory' class="row">

                                    <div class="col-md-6">
									<div class="form-group">
                                        <label class="inputLabel" for="">ইউজারের নাম
                                        </label>
										<input type="text" class="form-control" id="exampleInputFirstName" placeholder="ইউজারের নাম লিখুন" v-model="form.name">
                                    ...
                                    <div class="col-md-6">
									<div class="form-group">
                                        <label class="inputLabel" for="">পদবি</label>
